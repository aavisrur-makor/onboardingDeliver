  ...
  return (
    <Box sx={{padding:'0 4rem'}}>
      ...
      <Paper style={{maxHeight: "600px", overflow: 'auto'}}>
         ...
         <Box>
           <Typography className={classes.termsOfUseList}>2.Amendment to the Terms</Typography>
      ...
      >
        ...
        <Box>
          <Button className = {classes.termButtons} onClick={handleApprove}>Yes</Button>
          <Button className = {classes.termButtons}  onClick={handleReject}>No</Button>
        </Box>

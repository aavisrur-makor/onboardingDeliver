        ...
        <List style={{ maxHeight: "100%", overflow: "auto" }}>
          ...
          <Box>
            ...
            <Box className={classes.termsOfUseList}>
              ...
              “Service”). Enigma Securities Ltd (“Enigma”, “Us”, “We” or “Our”
              as appropriate) is a company registered in England and Wales with
              ...
              an Appointed Representative of Makor Securities London Ltd which
              is authorised and regulated (Reference No: 625054) by the
          ...
          <Box>
            <Box className={classes.termsOfUseList}>
              ...
              Terms. You understand that each order submitted to Enigma (whether
              by voice broking, email or via any other electronic interface that
              We may provide and/or accept) may result in Your entry into one or
              more binding transactions (a “Transaction”). You assume full
              financial and performance responsibility for all such Transactions
              created as a result of the process set out in these Terms.
            </Box>
          </Box>
          <Box>
            <Typography className={classes.termsOfUseList}>
            ...
            <Box className={classes.termsOfUseList}>
              ...
              amend the Terms at any time without prior notice to You. All

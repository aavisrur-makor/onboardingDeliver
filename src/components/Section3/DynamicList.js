      ...
      <Grid item md={11} container spacing={3}>
        <Grid item container spacing={3} md={12}>
          <Grid item md={4} xs={12}>
            <DynamicTextField required onChange={handleChange} id='first_name' label='First Name' index={props.index} />
          </Grid>
          <Grid item md={4} xs={12}>
            <DynamicTextField required onChange={handleChange} id='last_name' label='Last Name' index={props.index} />
          </Grid>
          <Grid item md={4} xs={12}>
            <CustomKeyBoardDatePicker required id='birthday_at' index={props.index} handleDynamicListChange={handleDynamicListChange} />
          </Grid>
        </Grid>
        <Grid item container spacing={3}>
          <Grid item md={6} xs={12}>
            <GoogleApiAutoComplete required contact index={props.index} handleSelect={handleDynamicListChange} id='address' label='Address' />
          </Grid>
          <Grid item md={6} xs={12}>
            <RoleSelectBox required contact index={props.index} id={'position_uuid'} label='Role' data={props.data ? props.data : null} handleSelect={handleDynamicListChange} />
          </Grid>
        </Grid>
      </Grid>
      {props.arrLength > 1 && (

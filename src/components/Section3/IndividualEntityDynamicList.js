      ...
      {alignment === 'individual' ? (
        <>
          <Grid item container xs={11} spacing={3}>
            ...
            <Grid item container md={12} spacing={3}>
              ...
              <Grid item md={4} xs={12}>
                <GoogleApiAutoComplete required handleSelect={handleDynamicListChange} id='address' index={props.index} contact label='Address' />
              </Grid>
              <Grid item md={4} xs={12}>
                <RoleSelectBox required handleSelect={handleDynamicListChange} index={props.index} id={'position_uuid'} label='Role' data='roles' />
              </Grid>
            </Grid>
          </Grid>
          {props.arrLength > 1 && (
        ...
        <>
          <Grid item container md={11} spacing={3}>
            <Grid item container md={12} spacing={3}>
              <Grid item md={2} xs={12}>
                <CustomToggleButton value={alignment} index={props.index} type={props.type} id='type' />
              </Grid>
              <Grid item md={5} xs={12}>
            ...
            <Grid item container md={12} spacing={3}>
              ...
              <Grid item md={6} xs={12}>
                <CountryAutoComplete contact required id='country' index={props.index} label='Country of incorporation' handleChange={handleAddAutoComplete} />
              </Grid>
            </Grid>
          </Grid>
          {props.arrLength > 1 && (
